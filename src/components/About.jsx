    ...
    return (
        <Grid id="about-section">
            <Grid 
                ...
                alignItems="center"
                w={{sm:"80%",base:"90%", md:"90%", lg:"100%"}} margin="auto"
            >
                <Intro />
                <Profile />
            </Grid>
            <Grid justifyContent="space-evenly" templateColumns= {{base:"1fr", sm:"1fr", md:"1fr",lg:"1fr 1fr 1fr"}} gap={5} my={{base:0,sm:10,md:10, lg:10}}>
                <SocialMediaIcons />
