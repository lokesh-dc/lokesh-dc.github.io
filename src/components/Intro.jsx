...
export default function Intro () {
    return (
            <Box p={{sm:0 , md:0, lg:20}} >
                    ...
                    <Text id="name" fontSize={{base:"3xl", sm:"3xl", md:"4xl",lg:"7xl"}}> I'm <span>Lokesh Choudhary</span> </Text>
                    <Text fontSize={{base:"2xl", sm:"3xl", md:"4xl",lg:"3xl"}} color="red">Web Developer</Text>
